...
def subscribe8(request):
    form = forms.Subscribe8()
    if request.method == 'POST':
        form = forms.Subscribe8(request.POST)
        ...
        return render(request, 'subscribe8/success.html', {'recepient': recepient})
    return render(request, 'subscribe8/index.html', {'form':form})
