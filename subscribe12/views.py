...
def subscribe12(request):
    form = forms.Subscribe12()
    if request.method == 'POST':
        form = forms.Subscribe12(request.POST)
        ...
        return render(request, 'subscribe12/success.html', {'recepient': recepient})
    return render(request, 'subscribe12/index.html', {'form':form})
