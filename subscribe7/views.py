...
def subscribe7(request):
    form = forms.Subscribe7()
    if request.method == 'POST':
        form = forms.Subscribe7(request.POST)
        ...
        return render(request, 'subscribe7/success.html', {'recepient': recepient})
    return render(request, 'subscribe7/index.html', {'form':form})
