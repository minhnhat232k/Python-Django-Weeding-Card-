...
def subscribe5(request):
    form = forms.Subscribe5()
    if request.method == 'POST':
        form = forms.Subscribe5(request.POST)
        ...
        return render(request, 'subscribe5/success.html', {'recepient': recepient})
    return render(request, 'subscribe5/index.html', {'form':form})
