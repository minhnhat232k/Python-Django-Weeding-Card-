...
def subscribe10(request):
    form = forms.Subscribe10()
    if request.method == 'POST':
        form = forms.Subscribe10(request.POST)
        ...
        return render(request, 'subscribe10/success.html', {'recepient': recepient})
    return render(request, 'subscribe10/index.html', {'form':form})
